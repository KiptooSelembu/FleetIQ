    ...
    <div class="trucker__container">
      <div class="trucker__footer-wrapper">
        <div class="trucker__footer-logo wow fadeInLeft">
          ...
          <p class="trucker__footer-logo-bottom-text">Centralized fleet management platform for <br> tracking fuel consumption, income, and <br> tax obligations efficiently</p>
          ...
          <div class="trucker__footer-email-phone">
            ...
            <div class="trucker__footer-email-phone-text">
              <a href="mailto:support@fleetiq.com" class="trucker__footer-email-text">support@fleetiq.com</a>
              <a href="tel:254700000000" class="trucker__footer-phone-text">+254 700 000 000</a>
            </div>
          </div>
        </div>
        <div class="trucker__footer-menu-wrapper wow fadeInUp">
          <div class="trucker__footer-menu">
            <h5 class="trucker__footer-menu-title">Quick Links</h5>
          ...
          <div class="trucker__footer-menu">
            <h5 class="trucker__footer-menu-title">Features</h5>
            <ul class="trucker__footer-menu-list">
              <li>
                <a href="#">
                  <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 11 11" fill="none">
